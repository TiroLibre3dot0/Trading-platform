...
import { User, LogOut, Settings, ChevronDown, ChevronRight, UserCheck, FileText, Shield, BarChart3, Download, MessageSquare, HelpCircle, Settings2, ToggleLeft, ToggleRight, Crown, Star, Award, XCircle } from 'lucide-react';
      ...
      <div className="p-4 bg-theme-secondary/30">
        <div className="flex items-center gap-3 mb-3">
          ...
          <button
            ...
            className="p-1.5 rounded-lg bg-theme-secondary/40 hover:bg-theme-secondary/60 transition-colors"
