              ...
              <tr key={m.symbol} className="border-t border-slate-800 hover:bg-slate-800">
                ...
                <td className="py-2">
                  <div className="flex items-center gap-2">
                    <div className="text-emerald-300 font-semibold">{fmt(m.bid)}</div>
                    <Icon title="Sell"><IconSell /></Icon>
                  </div>
                </td>
                <td className="py-2">
                  <div className="flex items-center gap-2">
                    <div className="text-rose-300 font-semibold">{fmt(m.ask)}</div>
                    <Icon title="Buy"><IconBuy /></Icon>
                  </div>
                </td>
                ...
                <td className="py-2">
                  <div className="flex items-center ml-auto gap-2">
                    <Icon title="Insights"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3 12h3l3 8 4-16 3 8h3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg></Icon>
                    <Icon title="Watchlist"><IconStar /></Icon>
                    <Icon title="Price alert"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 22c1.657 0 3-1.343 3-3h-6c0 1.657 1.343 3 3 3z" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/><path d="M18 8a6 6 0 10-12 0v5l-2 2h16l-2-2V8" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/></svg></Icon>
                    <Icon title="Info"><IconInfo /></Icon>
                  </div>
                </td>
              </tr>
            ))}
