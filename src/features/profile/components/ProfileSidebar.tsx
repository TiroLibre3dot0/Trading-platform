...
import { User, Zap, TrendingUp, Activity, Wallet, MessageCircle, Settings, CheckCircle, LogOut } from 'lucide-react';

const links = [
  { to: "/qlik-lab", label: "NEGOZIA", icon: Zap },
  { to: "/profile/positions", label: "POSIZIONI APERTE", icon: TrendingUp },
  { to: "/profile/history", label: "POSIZIONI CHIUSE", icon: TrendingUp },
  { to: "/profile/insights", label: "INSIGHTS", icon: Activity },
  { to: "/profile/funds", label: "FONDI", icon: Wallet },
];

const bottomLinks = [
  { to: "/support", label: "Chat Supporto", icon: MessageCircle },
];
